 ...
 */
int emit_gcode(const char *out, struct image *img, const struct pass *passes)
{
	...
	fprintf(file, "; Original image size: %ux%u pixels, %fx%f mm\n", img->w, img->h, img->mmw, img->mmh);
